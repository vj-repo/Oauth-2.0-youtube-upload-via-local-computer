...
$OAUTH2_CLIENT_ID = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com';
...
if (isset($_POST['submit']))
{
	...
	$path = "videos/" . str_shuffle("abcde") . $filename;
	
	if ((($filetype == "video/avi") || ($filetype == "video/mpeg") || ($filetype == "video/mpg") || ($filetype == "video/mov") || ($filetype == "video/wmv") || ($filetype == "video/rm") || ($filetype == "video/mp4")) && ($filesize < 8388608 and $filesize > 20))
	{
